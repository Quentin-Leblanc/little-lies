...
const NIGHT_AMBIANCE = [
  'Un cri a été entendu près de la taverne...',
  'Un chat noir a été aperçu sur le clocher de l\'église...',
  'Des bruits de pas résonnent dans la ruelle sombre...',
  'Une ombre furtive se glisse entre les maisons...',
  'La porte de la forge grince... quelqu\'un est entré.',
  'Un hurlement lointain déchire le silence de la nuit.',
  'Du sang frais a été trouvé près du puits...',
  'Quelqu\'un chuchote derrière les volets clos...',
  'Une fenêtre se brise dans le quartier nord...',
  'Le vent transporte une odeur de métal et de peur...',
  'Un villageois a été vu errant seul dans les ruelles...',
  'Les torches vacillent comme si quelqu\'un courait...',
  'Un bruit sourd résonne depuis la cave de la taverne...',
  'Une silhouette encapuchonnée traverse la place...',
  'Le bois de la potence grince sous le vent...',
  'On entend des pleurs étouffés derrière une porte...',
  'La lune disparaît derrière les nuages... l\'obscurité totale.',
  'Un couteau a été trouvé abandonné près de l\'église...',
  'Quelqu\'un a frappé à toutes les portes... puis s\'est enfui.',
  'Les chiens du village aboient sans raison apparente...',
  'Une traînée de boue mène de la forge jusqu\'à la forêt...',
  'Le veilleur de nuit n\'est jamais revenu de sa ronde...',
];
